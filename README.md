...
Agent State (APSS) stores agent conversation context for long-term persistence.

Architecture: [Agent State](https://github.com/agynio/architecture/blob/main/architecture/agent/state.md)
